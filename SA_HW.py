...
def random_neighbour(x, fraction=1):
    amplitude = (max(interval) - min(interval)) * (fraction)
...
annealing(random_start, cost_function, random_neighbour, acceptance_probability, temperature, maxsteps=250, debug=True);